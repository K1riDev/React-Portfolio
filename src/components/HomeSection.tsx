      ...
      <div className=" h-full w-full flex flex-col items-center mt-40 lg:mt-72 xxl:mt-96 gradient z-20 bg-transparent">
        ...
        >
          <div className="flex flex-row justify-center gap-2 text-firstwhite text-lg lg:text-3xl xxl:text-4xl font-medium bg-transparent">
            <p className=" word opacity-0 scale-0 text-center">Hola,</p>
            <p className="word opacity-0 scale-0 text-center"> Soy</p>
          </div>
          ...
          Soy un desarrollador web junior autodidacta.
          Todo lo que he aprendido hasta ahora se lo debo a midudev y a toda su comunidad.
          </p>
        </div>
